...
require (
	...
	github.com/redhat-appstudio/managed-gitops/backend-shared v0.0.0-20221213192646-02c27cd35f34
	github.com/redhat-appstudio/managed-gitops/utilities/db-migration v1.0.0-20221123035345-087515c78044
